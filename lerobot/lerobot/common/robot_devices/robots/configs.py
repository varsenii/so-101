...
class So101RobotConfig(ManipulatorRobotConfig):
    ...
    follower_arms: dict[str, MotorsBusConfig] = field(
        default_factory=lambda: {
            "main": FeetechMotorsBusConfig(
                port="/dev/ttyACM_so101_follower",
                motors={
                    # name: (index, model)
                    "shoulder_pan": [1, "sts3215"],
                    "shoulder_lift": [2, "sts3215"],
    ...
    cameras: dict[str, CameraConfig] = field(
        default_factory=lambda: {
            "wrist": OpenCVCameraConfig(
                camera_index='/dev/v4l/by-id/usb-Sonix_Technology_Co.__Ltd._USB2.0_CAM1_USB2.0_CAM1-video-index0',
                fps=30,
                width=640,
                height=480,
            ),
            "overhead": OpenCVCameraConfig(
                camera_index='/dev/v4l/by-id/usb-Intel_Corporation_Luxonis_Device_18443010F12BC80F00-video-index0',
                fps=60,
                width=640,
                height=480,
                color_mode="bgr",
